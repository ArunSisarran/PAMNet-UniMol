...
class ADMET(InMemoryDataset):
    ...
    def __init__(self, root, tdc_dataset_name, mode='train',transform=None, pre_transform=None, pre_filter=None):
        ...
        self.mode = mode
        super(ADMET, self).__init__(root, transform, pre_transform, pre_filter)
    ...
    def process(self):
        ...
        for index, row in tqdm(df.iterrows(), total=df.shape[0]):
            ...
            if res != 0:
                res = AllChem.EmbedMolecule(mol, randomSeed=42, useRondomCoords=True)
